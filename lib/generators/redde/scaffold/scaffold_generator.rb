    ...
    class ScaffoldGenerator < ::Rails::Generators::Base
      ...
      def columns
        begin
          ...
          @model_name.constantize.columns.reject{|c| excluded_column_names.include?(c.name) || c.name.index("_id") }.sort{|a, b| sort_priority(b.name) <=> sort_priority(a.name)}.collect{|c| ::Rails::Generators::GeneratedAttribute.new(c.name, c.type)}
